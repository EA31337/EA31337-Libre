...
input unsigned int Force_Active_Tf =  2;       // Force: Activated timeframes
...
input unsigned int MFI_Active_Tf =  8;         // MFI: Activated timeframes
input unsigned int Momentum_Active_Tf = 8;     // Momentum: Activated timeframes
input unsigned int OBV_Active_Tf =  8;         // OBV: Activated timeframes
input unsigned int OsMA_Active_Tf = 0;         // OsMA: Activated timeframes
input unsigned int RSI_Active_Tf = 8;          // RSI: Activated timeframes
...
input unsigned int WPR_Active_Tf = 8;          // WPR: Activated timeframes
