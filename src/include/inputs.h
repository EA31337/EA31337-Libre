...
input unsigned int AC_Active_Tf = 15;   // AC: Activated timeframes
input unsigned int AD_Active_Tf = 15;   // AD: Activated timeframes
...
input unsigned int ZigZag_Active_Tf = 15;      // ZigZag: Activated timeframes
